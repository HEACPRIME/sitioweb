			...
			<div class="row full-height justify-content-center">
				<div class="col-12 text-center align-self-center py-5">
					<div class="section pb-5 pt-5 pt-sm-2 text-center">
						<h5 class="mb-0 pb-3"><font color="#12a39e"><span><a href="index.view.php" ><font color="#12a39e">Home</a></span></font></h5>
						<!-- <div>
								...
								<div class="card-front">
									<div class="center-wrap">
										...
										<div class="section text-center">
											<form class="formulario" name="recu" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
												...
												<button class="btn mt-4" onclick="recu.submit()" id="submit">Recovery</button>
