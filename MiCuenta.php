...
if(isset($_POST['forgotSubmit'])){
    ...
    if(!empty($_POST['email'])){
		...
		if($prevUser > 0){
			...
			if($update){
				$resetPassLink = 'http://localhost:81/medicOnline/ReiniciarPassword.php?fp_code='.$uniqidStr;
				...
				<br/>Se ha enviado una solicitud para restablecer una contraseña para su cuenta. Si esto fue un error, simplemente omita este correo electrónico.
				...
				//additional headers
				$headers .= 'From: Reaver<https://paginaweb.santacecilia.edu.sv/RiverNivelDios/index.php>' . "\r\n";
				//send email
