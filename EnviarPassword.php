								...
								<div class="card-front">
									<div class="center-wrap">
										...
										<div class="section text-center">
											...
											<form class="formulario" name="recu" action="MiCuenta.php" method="POST">
												<div class="form-group mt-2">
													<i class="input-icon uil  uil-envelope-alt"></i><input type="text" name="email" class="form-style" placeholder="Your Email" autocomplete="off">
												</div>
												<div class="send-button">
													<input type="submit" name="forgotSubmit" value="RECOVERY">
												</div>
