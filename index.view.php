      ...
      <div class="container d-flex align-items-center">
        ...
        <nav id="navbar" class="navbar order-last order-lg-0">
          <ul>
           ...
           <a href="login.php" class="appointment-btn scrollto"><span class="d-none d-md-inline">Login or </span> Register</a>
    ...
    <section id="appointment" class="appointment section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <form action="forms/appointment.php" method="post" role="form" class="php-email-form" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="row">
            ...
            <div class="col-md-4 form-group mt-3">
              <select name="department" id="department" class="form-select">
                ...
                <option value="Department 1">Consult</option>
                <option value="Department 2">Help</option>
                <option value="Department 3">Question</option>
              </select>
            </div>
            <div class="col-md-4 form-group mt-3">
          ...
          <div class="text-center"><button id="submit" type="submit">Make an Appointment</button></div>
        </form>
